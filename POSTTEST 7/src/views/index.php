...
<head>
  ...
  <title>GameHive - True Gamers Find Epic Fun!</title>
...
<body id="top">
    ...
    <div class="container">
      ...
      <nav class="navbar" data-navbar>
        <ul class="navbar-list">
          ...
          <li class="navbar-item">
            <a href="tambah.php" class="navbar-link" data-nav-link>Daftar</a>
          </li>
          ...
          <ul>
            ...
            <a href="bio.php" class="btn" data-btn>About Me</a>
          ...
          <ol class="upcoming-list">
            ...
            <li class="upcoming-item">
              ...
              <div class="upcoming-time" data-reveal="bottom">
                ...
                <time class="date" datetime="2023-05-25">25TH May 2024</time>
            ...
            <li class="upcoming-item">
              ...
              <div class="upcoming-time" data-reveal="bottom">
                ...
                <time class="date" datetime="2023-01-10">10TH Jan 2024</time>
            ...
            <li class="upcoming-item">
              ...
              <div class="upcoming-time" data-reveal="bottom">
                ...
                <time class="date" datetime="2023-12-15">15th Dec 2024</time>
                ...
                <div class="card-content">
                  ...
                  <ul class="card-meta-list">
                    ...
                    <li class="card-meta-item">
                      ...
                      <time class="card-meta-text" datetime="2023-01-01">Jan 01 2024</time>
                    </li>

                    <li class="card-meta-item">
                      <ion-icon name="person-outline" aria-hidden="true"></ion-icon>

                      <p class="card-meta-text">Sannie Octavhia</p>
                    </li>
        ...
        <div class="footer-list">
          ...
          <div class="contact-item">
            ...
            <address class="contact-link">
              Jl Perjuangan 2 No 2, Samarinda Utara
            </address>
          </div>
          ...
          <div class="contact-item">
            ...
            <a href="tel:0812345678" class="contact-link">+62 812-345-678</a>
          </div>
  ...
  <script>
    ...
    if($("body").hasClass("dark-mode")){
      $(".swicth").attr("name", "sunny-outline");
    } else {
      $(".swicth").attr("name", "moon-outline")
    }
  });
  </script> 
